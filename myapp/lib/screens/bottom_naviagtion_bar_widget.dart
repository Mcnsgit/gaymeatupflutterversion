...
class BottomNavBarTransparentFb1 extends StatefulWidget {
  ...
  const BottomNavBarTransparentFb1({
    Key? key,
    required this.onItemTapped, required String initialRoute, required Widget Function(dynamic context) onChatRoute, required Widget Function(dynamic context) onUserProfileRoute, required Widget Function(dynamic context) onVideoCallRoute, required HomeScreen Function(dynamic context) onHomeRoute,
  }) : super(key: key);
...
@override
  ...
  State<BottomNavBarTransparentFb1> createState() => BottomNavBarTransparentFb1State();
}  
class BottomNavBarTransparentFb1State extends State<BottomNavBarTransparentFb1> {
  @override
